...
const frameworkItems = [
  {
    title: "관찰 우선",
    body: "바로 매수하기보다 먼저 살펴볼 종목을 정리하는 화면입니다."
  },
  {
    title: "기준 이탈 우선",
  ...
  {
    title: "검증 연결",
    body: "비슷한 흐름에서 어떤 결과가 나왔는지 함께 붙여서 해석을 돕습니다."
  }
];
    ...
    <section className="grid gap-6 xl:grid-cols-[1.2fr_0.8fr]">
      ...
      <Card>
        ...
        <CardContent className="space-y-3 text-sm leading-6 text-muted-foreground">
          ...
          <p>특히 기준 이탈 가격이 현재가와 가깝다면 좋은 점수라도 보수적으로 볼 필요가 있습니다.</p>
