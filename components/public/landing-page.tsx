...
export function LandingPage() {
  return (
    <main className="space-y-24 pb-16">
      <section className="relative overflow-hidden rounded-[40px] border border-[hsl(220_18%_16%_/_0.08)] bg-[linear-gradient(145deg,hsl(220_26%_12%),hsl(210_18%_18%)_42%,hsl(38_32%_22%)_100%)] px-6 py-8 text-white shadow-[0_40px_120px_hsl(220_22%_12%_/_0.22)] sm:px-8 sm:py-10 lg:px-10 lg:py-12">
        ...
        <div className="relative grid gap-10 xl:grid-cols-[minmax(0,1.02fr)_minmax(460px,0.98fr)] xl:items-end">
          <div className="space-y-8">
            <div className="space-y-4">
              ...
              <div className="space-y-5">
                <h1 className="max-w-5xl text-balance text-5xl font-semibold leading-[0.96] tracking-[-0.08em] text-white sm:text-[5.4rem]">
                  오늘 무엇을 해야 하는지
                  <br />
                  먼저 답하는 스윙 서비스.
                </h1>
                <p className="max-w-3xl text-base leading-8 text-white/72 sm:text-lg">
                  SWING-RADAR는 종목을 많이 나열하는 대신, 장전 후보를 만들고 장초에 다시 확인한 뒤 실제로 검토할 0~2개의 행동만
                  남기는 개인 운용 대시보드입니다.
                </p>
              </div>
            </div>
            ...
            <div className="grid gap-3 md:grid-cols-3">
              {promiseStrip.map((item) => (
                <div
                  key={item.label}
                  className="rounded-[26px] border border-white/10 bg-white/6 px-4 py-4 backdrop-blur-sm"
                >
                  <p className="text-[11px] font-semibold uppercase tracking-[0.22em] text-white/50">{item.label}</p>
                  <p className="mt-3 text-3xl font-semibold tracking-[-0.06em] text-white">{item.value}</p>
          ...
          <div className="relative">
            ...
            <div className="relative rounded-[34px] border border-white/12 bg-[linear-gradient(180deg,rgba(255,255,255,0.16),rgba(255,255,255,0.08))] p-4 backdrop-blur-xl sm:p-5">
              <div className="rounded-[28px] border border-white/12 bg-[linear-gradient(180deg,rgba(16,23,37,0.94),rgba(22,29,44,0.98))] p-5 shadow-[inset_0_1px_0_rgba(255,255,255,0.08)]">
                <div className="flex items-center justify-between gap-3 border-b border-white/8 pb-4">
                  <div>
                    <p className="text-[11px] font-semibold uppercase tracking-[0.24em] text-white/44">Today board</p>
                    <p className="mt-2 text-2xl font-semibold tracking-[-0.05em] text-white">오늘 실제 행동 2개</p>
                  </div>
      ...
      <section id="overview" className="grid gap-8 lg:grid-cols-[minmax(0,0.8fr)_minmax(0,1.2fr)]">
        <div className="space-y-4 lg:sticky lg:top-28 lg:self-start">
          ...
          <h2 className="max-w-xl text-balance text-4xl font-semibold leading-[1.02] tracking-[-0.06em] text-foreground sm:text-[3.3rem]">
        ...
        <div className="space-y-4">
          {painNarrative.map((item, index) => (
            <article
              key={item.title}
              className="rounded-[32px] border border-border/70 bg-white/76 p-6 shadow-[0_24px_80px_hsl(33_22%_26%_/_0.06)] backdrop-blur-xl sm:p-8"
            >
              <div className="flex items-start gap-4">
                ...
                <div className="space-y-3">
                  <h3 className="text-2xl font-semibold tracking-[-0.04em] text-foreground">{item.title}</h3>
      ...
      <section id="workflow" className="space-y-6">
        <div className="grid gap-6 lg:grid-cols-[minmax(0,0.9fr)_minmax(0,1.1fr)] lg:items-end">
          <div className="space-y-4">
            ...
            <h2 className="max-w-3xl text-balance text-4xl font-semibold leading-[1.02] tracking-[-0.06em] text-foreground sm:text-[3.2rem]">
              장전 후보에서 끝나지 않습니다.
              <br />
              장초 확인을 거쳐야 오늘 행동이 됩니다.
            </h2>
          </div>
          <div className="rounded-[30px] border border-border/70 bg-white/72 px-5 py-5 text-sm leading-7 text-muted-foreground shadow-[0_18px_56px_hsl(33_22%_24%_/_0.05)] backdrop-blur-xl sm:px-6">
      ...
      <section id="product" className="space-y-8">
        <div className="flex flex-col gap-4 lg:flex-row lg:items-end lg:justify-between">
          ...
          <div className="max-w-xl rounded-[28px] border border-border/70 bg-white/72 px-5 py-5 text-sm leading-7 text-muted-foreground shadow-[0_18px_56px_hsl(33_22%_24%_/_0.05)] backdrop-blur-xl">
        ...
        <div className="grid gap-4 lg:grid-cols-12">
          {productSurfaces.map((item) => {
            ...
            return (
              <section
                key={item.title}
                className={`rounded-[32px] border border-border/70 bg-white/78 p-6 shadow-[0_24px_80px_hsl(33_22%_26%_/_0.06)] backdrop-blur-xl ${item.span}`}
              >
        ...
        <div className="grid gap-4 md:grid-cols-3">
          {[
            ...
            return (
              <div
                key={item.title}
                className="rounded-[28px] border border-border/70 bg-[linear-gradient(180deg,hsl(35_23%_98%_/_0.92),hsl(33_18%_95%_/_0.98))] px-5 py-5 shadow-[0_18px_56px_hsl(33_22%_24%_/_0.05)]"
              >
                <div className="flex items-center gap-3">
      ...
      >
        <div className="grid gap-10 xl:grid-cols-[minmax(0,0.86fr)_minmax(0,1.14fr)]">
          <div className="space-y-4">
            ...
            <h2 className="max-w-xl text-balance text-4xl font-semibold leading-[1.02] tracking-[-0.06em] text-foreground sm:text-[3rem]">
              사용자가 바로 묻는 질문부터
              <br />
              짧고 분명하게 답합니다.
            </h2>
            <p className="max-w-lg text-base leading-8 text-muted-foreground">
              로그인 전에는 서비스가 어떤 원리로 종목 수를 줄이는지 이해하고, 로그인 후에는 내 기준의 운용 화면으로 바로 이어지게
              만드는 것이 목표입니다.
            </p>
            <div className="pt-2">
          ...
          <div className="space-y-3">
            {faqs.map((item) => (
              <article key={item.question} className="rounded-[26px] border border-border/70 bg-white/82 px-5 py-5">
                <h3 className="text-lg font-semibold tracking-[-0.03em] text-foreground">{item.question}</h3>
