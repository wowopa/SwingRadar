...
$DailyStartTime = Resolve-SwingRadarSetting -Name "SWING_RADAR_DAILY_TASK_START_TIME" -ExplicitValue $DailyStartTime -DefaultValue "04:00" -EnvConfig $envConfig
...
$AutoHealStartTime = Resolve-SwingRadarSetting -Name "SWING_RADAR_AUTO_HEAL_START_TIME" -ExplicitValue $AutoHealStartTime -DefaultValue "05:30" -EnvConfig $envConfig
