...
describe("getTrackingSnapshot", () => {
    ...
    mocks.getTracking.mockResolvedValue({
      ...
      details: {
        h1: {
          historyId: "h1",
          summary: "s1",
          invalidationReview: "i1",
          afterActionReview: "a1",
          reviewChecklist: [],
          metrics: [],
          chartSnapshot: [],
          historicalNews: [],
        ...
        h2: {
          historyId: "h2",
          summary: "s2",
          invalidationReview: "i2",
          afterActionReview: "a2",
          reviewChecklist: [],
          metrics: [],
          chartSnapshot: [],
          historicalNews: [],
  ...
  it("filters history and trims details to matching ids", async () => {
    mocks.listOpeningRecheckScans.mockResolvedValue([
      {
        scanKey: "2026-03-01T00:05:00.000Z",
    ...
    const result = await getTrackingSnapshot({
      ticker: "삼성",
      result: "진행중",
      from: "2026-03-01",
      to: "2026-03-31",
    ...
    expect(result.details.h1?.openingCheckInsight).toMatchObject({
      status: "passed",
      outcome: "active",
      matchedBy: "signal_date"
    });
  });
    ...
    mocks.getTracking.mockResolvedValue({
      ...
      details: {
        h3: {
          historyId: "h3",
          summary: "s3",
          invalidationReview: "i3",
          afterActionReview: "a3",
          reviewChecklist: [],
          metrics: [],
          chartSnapshot: [],
          historicalNews: [],
